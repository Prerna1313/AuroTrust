...
export default function HowItWorks() {
  const steps = [
    {
      number: '1️⃣',
      title: 'Donate Cross-Chain',
      description: 'Choose a project, token, and network (APT, ETH, USDC).'
    },
    {
      number: '2️⃣',
      title: 'Smart Escrow Activation',
      description: 'Funds are securely locked via Move contract until verified.'
    },
    {
      number: '3️⃣',
      title: 'Transparent Tracking',
      description: 'Every update is visible on your public dashboard.'
    }
  ];
      ...
      <VStack gap={12} maxW="1200px" mx="auto">
        ...
        <Grid templateColumns={["1fr", "1fr", "repeat(3, 1fr)"]} gap={8}>
          {steps.map((step, index) => (
            ...
            >
              <VStack gap={4}>
                <Text fontSize="5xl">{step.number}</Text>
                <Heading fontSize="xl" color="#3EF67D">{step.title}</Heading>
